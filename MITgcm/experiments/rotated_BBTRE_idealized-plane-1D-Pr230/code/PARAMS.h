...
C     lapseRate  :: Background vertical temperature gradient ( K/m )
C     slopeAngle :: Angle of rotation of reference frame in (x,z) plane ( rad )
C     prandtlNum :: Turbulent Prandtl Number (for U and V)
...
C     psiEuler      :: Euler angle, rotation about new z-axis
     ...
     & lapseRate, slopeAngle, prandtlNum,
